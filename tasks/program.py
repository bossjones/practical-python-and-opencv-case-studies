...
def get_crud_interfaces(ctx, loc="local"):
    """
    Display all crud interfactes for practical-python-and-opencv-case-studies
    ...
    _cmd = "grep \",\" practical_python_and_opencv_case_studies/api/crud/__init__.py | grep -v \"^#\" | tr ',' '\n' | /usr/bin/xargs"
