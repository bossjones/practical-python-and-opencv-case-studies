...
#     # ctx.run("python ./practical_python_and_opencv_case_studies/api/backend_pre_start.py")
#     # ctx.run("python ./practical_python_and_opencv_case_studies/initial_data.py")
#     # ctx.run("python practical_python_and_opencv_case_studies/dev_serve.py")
...
pip install -r requirements-doc.txt
    ...
    click.secho(
        "[install] install editable version of practical-python-and-opencv-case-studies",
        fg=COLOR_SUCCESS,
    )
    ctx.run("pip install -e .")
...
def rsync(ctx, loc="local", verbose=0, cleanup=False):
    """
    rsync over files to ~vagrant/practical-python-and-opencv-case-studies folder
    ...
    _cmd = r"""
cd && rsync -r --exclude practical-python-and-opencv-case-studies_venv --exclude .vagrant --exclude .git --exclude .env /srv/vagrant_repos/practical_python_and_opencv_case_studies/ ~/practical_python_and_opencv_case_studies/ && sudo chown vagrant:vagrant -R ~vagrant && cd ~/practical-python-and-opencv-case-studies && ls -lta
    """
...
pip install -e .
    ...
    ctx.run("practical_python_and_opencv_case_studiesctl --help")
...
def pstree(ctx, loc="local", verbose=0, cleanup=False):
    ...
    # lsof -nP +c 15 | grep LISTEN
    _cmd = r"""
ps aux | grep 'python practical_python_and_opencv_case_studies/web.py' | awk '{print $2}' | head -1
    """
