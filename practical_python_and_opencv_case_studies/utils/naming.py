...
def magic_name(value, *, path_prefix):
    ...
    try:
        ...
        # https://github.com/practical_python_and_opencv_case_studies/practical_python_and_opencv_case_studies/pull/1635
        if inspect.isframe(frame):
            frame = frame.f_back

        # Iterate frames while filename starts with path_prefix (part of practical_python_and_opencv_case_studies)
