...
MAKE := make
PY_MODULE_NAME := practical-python-and-opencv-case-studies
...
PACKAGE_NAME="practical-python-and-opencv-case-studies"
...
RTD_DOC_URL="https://practical-python-and-opencv-case-studies.readthedocs.io/index.html"
...
run-black-check: ## CHECK MODE: sensible pylint ( Lots of press over this during pycon 2018 )
	black --check --exclude=practical-python-and-opencv-case-studies_venv*,*.eggs --verbose .

.PHONY: run-black
run-black: ## sensible pylint ( Lots of press over this during pycon 2018 )
	black --verbose --exclude=practical-python-and-opencv-case-studies_venv*,*.eggs .
